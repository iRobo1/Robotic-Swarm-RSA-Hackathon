...
robot = Robot() # Create the robot class!
...
# Callbacks for the communications
...
# Any custom messages have the same callback. Receive the message and 
# write own function that dispatches what to do with that message
